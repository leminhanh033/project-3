...
export const Section1 = () => {
  useEffect(() => {
    ...
    validator.addField('#search-input',
      [
        {
          rule: 'required',
          errorMessage: "Nhập từ khoá",
        },
      ])
  })
  return (
    <>
      ...
      <div className="section-1 bg-[#000065]" >
        <div className="container py-[60px] flex flex-col items-center gap-[30px]">
          ...
          <form id="search-form" className="w-[100%] flex gap-[15px] flex-col md:flex-row ">
            ...
            <div  className="flex-1 h-[56px] bg-[#FFFFFF] rounded-[4px] py-[18px] pl-[20px] relative " >
              <input id="search-input" type="text" placeholder="Nhập từ khoá..." />
            </div>
