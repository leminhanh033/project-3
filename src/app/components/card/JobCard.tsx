...
export const JobCard = () => (
    <>
        <div className="mt-[30px] flex items-center flex-col sm:grid lg:grid-cols-3 sm:grid-cols-2 gap-y-[20px] sm:gap-x-[20px] gap-x-[10px] ">
            ...
            <div className="py-[20px] flex flex-col items-center relative rounded-[8px] overflow-hidden sm:w-auto w-[350px]"
                ...
                <div className="mt-[20px] font-[700] md:text-[18px] text-[14px] text-center px-[16px] line-clamp-2">
                    <Link href="#">Frontend Engineer (ReactJS)</Link>
                </div>
