...
export const LoginEmployee = () => {
    useEffect(() => {
        const validate = new JustValidate('#LoginEmployeeForm', {
            errorFieldStyle: {},
        });
        validate
            .addField('#email', [
    ...
    return <>
        <form id="LoginEmployeeForm" action="" className="mt-[20px] flex flex-col gap-[15px] text-[14px] font-[500] text-[#000000]">
            <div>
